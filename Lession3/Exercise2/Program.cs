...
public class Program
{
    public static void Main()
    {
        ...
        var sortedStudents = from s in studentList orderby s.StandardID, s.Age select new
                             {
        ...
        var nestedQueries = from s in studentList where s.Age > 18 && s.StandardID ==
                            (from std in standardList where std.StandardName == "Standard 1" select std.StandardID).FirstOrDefault() select s;
